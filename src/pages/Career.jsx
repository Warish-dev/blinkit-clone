...
function Career() {
  ...
  return (
    <div>
      <TopBar />
      <div >
        <img src={image2} alt="Career Hero" />
      </div>
      <div >
        <div >
          <div >
          ...
          <div >
            ...
            <div ><iframe width="100%" height="100%" src="https://www.youtube.com/embed/DxDU7QBNEbM?si=IzRozMOnPkDpxaCg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin"  allowfullscreen></iframe></div>
          </div>
